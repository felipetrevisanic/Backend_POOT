...
class perguntaController {
  ...
  static criarPergunta = async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .send({ message: `${error} - não foi possivel inserir o pergunta` });
    }
  };
  ...
  static AtualizarPergunta = async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .send({ message: `${error} - não foi possivel atulizar pergunta` });
    }
  };
  ...
  static excluirPergunta = async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .send({ message: `${error} - não foi possivel excluir pergunta` });
    }
  };
}
